...
<body>
    <div class="topo">
        ...
        <nav class="navbar navbar-expand-sm  navbar-dark" styles="widht: 150px">
          ...
          <img src="./2-removebg-preview (1).png" alt="eu" widht=200px height= 150px >
            <a class="navbar-brand" href="#"> <h1>  Atividade - Formulário de Cadastro de Disciplinaas :) </h1></a> 
    ...
    <div class="conteudo" style="background-color: rgba(155, 167, 238, 0.747);">
         ...
         <h1>Formulário: </h1>
     <form action="caddisciplina.php" method="get" style= " display: flex; flex-direction: row; flex-wrap: wrap; height: 500px; width: 400px; padding: 100px; justify-content: flex-start; padding-top: 10px; align-items: flex-start;">
    <div>
